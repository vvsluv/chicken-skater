...
/** @type {string} */
const CACHE_VERSION = '1763664008|85798964';
/** @type {string} */
const CACHE_PREFIX = 'ChickenSkater-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'ChickenSkater.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["ChickenSkater.html","ChickenSkater.js","ChickenSkater.offline.html","ChickenSkater.icon.png","ChickenSkater.apple-touch-icon.png","ChickenSkater.audio.worklet.js","ChickenSkater.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["ChickenSkater.wasm","ChickenSkater.pck"];
